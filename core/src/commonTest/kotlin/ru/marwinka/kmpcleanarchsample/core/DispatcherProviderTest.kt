...
class DispatcherProviderTest {
    ...
    @Test
    fun io_allows_more_concurrent_work_than_available_cpu_cores() =
        runBlocking {
    ...
    @Test
    fun default_dispatcher_executes_suspending_work_and_returns_result() =
        runBlocking {
            val result =
    ...
    @Test
    fun io_dispatcher_runs_several_coroutines_concurrently() =
        runBlocking {
