 ...
 */
private class FakeTaskRepository(private val tasks: List<Task>) : TaskRepository {
...
class TaskUseCasesTest {
    ...
    @Test
    fun getActiveTasks_returns_tasks_from_repository() = runBlocking {
    ...
    @Test
    fun toggleTaskDone_delegates_to_repository() = runBlocking {
