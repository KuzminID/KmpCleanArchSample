...
private class FakeTaskHistoryRepository(private val entries: List<TaskHistoryEntry>) : TaskHistoryRepository {
...
class GetTaskHistoryUseCaseTest {
    ...
    @Test
    fun returns_entries_from_repository() = runBlocking {
        val entries = listOf(
